...
class CreateBookingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('bookings', function (Blueprint $table) {
            ...
            $table->string('bookingLandmark', 50)->nullable();;
            $table->string('bookingTripType', 50)->nullable();;
            $table->string('date', 50)->nullable();;
            $table->string('time', 50)->nullable();;
            $table->string('bookingAddressFrom', 100)->nullable();;
            $table->string('bookingAddressTo', 100)->nullable();;
            ...
            $table->UnsignedInteger('bookingPhone', 20)->nullable();;
